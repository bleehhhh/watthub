...
newtpseat("Barbarian Rice TP", wksp.BarbStores:FindFirstChild("Food Store").CustomerSeat.CFrame)
newtpseat("Town Rice TP", CFrame.new(6.04245, 23.4297, 402.954))
newtpseat("Kart", wksp.BarbStores:FindFirstChild("Kart").CustomerSeat.CFrame)
newtpseat("Farmkart", wksp.BarbStores:FindFirstChild("FarmKart").CustomerSeat.CFrame)
newtpseat("Barbarian", wksp.BarbStores:FindFirstChild("Admission").CustomerSeat.CFrame)
newtpseat("Peasant Village", wksp.BarbStores:FindFirstChild("PeasantFishingNet").CustomerSeat.CFrame)
newtpseat("Arena", wksp.Arena.VisualArena.Chair.Seat.CFrame)
newtpseat("Ally's", CFrame.new(-176.041, 1.85007, 52.2702))
newtpseat("Peasant Admission",  wksp.Admission.CustomerSeat.CFrame)
newtpseat("Tavern", wksp["_VisualMap"].Tavern.Chair.Seat.CFrame)
newtpseat("Beach",  wksp.Crab.BeachUmbrella:FindFirstChild("Chair").Seat.CFrame)
newtpseat("Guard Area", CFrame.new(63.6739, 23.4297, 292.186))
newtpseat("Doctor Area", CFrame.new(14.5735, 23.3683, 265.75))
newtpseat("Tools Area", CFrame.new(90.0738, 23.4297, 403.586))
newtpseat("Jail", wksp.Jail.Stands:FindFirstChild("Seat").CFrame)
